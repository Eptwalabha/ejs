			...
			<div class="subBodyBody">
				...
				?>
						<tr class="line_<?php echo ($count % 2); ?>">
							<td><?php echo $c->getUserId(); ?></td>
							<td><a href="<?php echo WEBROOT."mon_espace/profil/".$c->getUserPseudo(); ?>"><?php echo $c->getUserPseudo(); ?></a></td>
							<td><?php echo $c->getUserField('en_name'); ?></td>
							<td><?php echo $c->getUserField('en_siret'); ?></td>
						</tr>
				<?php
						$count++;
					}
