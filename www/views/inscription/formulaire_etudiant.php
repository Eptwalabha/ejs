			...
			<div class="subBodyContent" >
				<div>
					...
					<form action="<?php echo WEBROOT; ?>inscription/valid_student" method="post" class="inscription">
						<div class="line_form"><label title="de 4 à 20 caractères alphanumériques" for="st_login">Pseudo/Login (de 4 à 20 caractères alphanumériques)<?php echo getMessage($valide, "login"); ?></label><span class="saisie"><input type="text" name="login" id="st_login" class="textfield" <?php echo getFormValue('login'); ?>required/></span></div>
						...
						<div class="line_form"><label title="6 caractères minimum" for="st_psw1">Mot de passe (6 caractères minimum)<?php echo getMessage($valide, "psw1"); ?></label><span class="saisie"><input type="password" name="psw1" id="st_psw1" class="textfield" required/></span></div>
						<div class="line_form"><label for="st_psw2">Confirmez le mot de passe<?php echo getMessage($valide, "psw2"); ?></label><span class="saisie"><input type="password" name="psw2" id="st_psw2" class="textfield" required/></span></div>
